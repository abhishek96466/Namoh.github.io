...
<!-- <style>
    ...
    <!-- <div class="container-fluid">
        <p id="time" class="text-right"></p>
    </div> -->
    <div class="container">
        <h2 class="text-center py-0">iDiscuss - Categories</h2>
            ...
            while($row=mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-md-4">
                            <div class="card my-3" style="width: 18rem;">
                                <img src="https://source.unsplash.com/800x500/?coding,'. $cat . '" class="card-img-top" alt="...">
                            <div class="card-body">
